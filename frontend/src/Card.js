...
<div id="card">
                <div id="dot-cont">
                    ...
                    <div id="dot">
                        <img src="./asserts/dot.png" width="20em" height="20em" alt="dots"></img>
                    </div>
                </div>
                <div>
                ...
                <div id="date-con">
                <img src="./asserts/like.png" width="30px" height="20px"  alt="like" id="likeimg"></img>
                <img src="./asserts/share.png" width="30px" height="20px" id="imgd" alt="share"></img>
